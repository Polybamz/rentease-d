        ...
        <div className="mx-auto max-w-7xl px-4 py-20 md:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
              Search real listings, message landlords directly, and manage your tenancy — all in one
              calm, trustworthy place built for students.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-2 rounded-2xl border bg-card p-2 shadow-[var(--shadow-card)] md:flex-row md:items-center">
              ...
              <Button asChild size="lg" className="md:ml-2">
                <Link to="/browse" search={{ q: q || undefined }}>
                  Search
                </Link>
              </Button>
            </div>
          ...
          {[
            {
              ...
              body: "Filter by price, distance, room type, and amenities. Every landlord is verified.",
            },
            {
              icon: MessageCircle,
              title: "Message landlords directly",
              body: "Ask questions and book viewings without leaving the app.",
            },
            {
              icon: Home,
              title: "Move in with confidence",
              body: "Manage your tenancy, payments, and reviews in one dashboard.",
            },
          ].map((s, i) => (
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {[
            {
              n: "Maya P.",
              t: "Signed my lease in 3 days. The verified badge gave me real peace of mind.",
            },
